...
const WrestlerProfileScreen = ({ navigation }) => {
...
export default WrestlerProfileScreen;
...
const styles = StyleSheet.create({
  ...
  aboutTab: {
    // Left tab style if needed
  },
  resultTab: {
    color: '#fff', // White for the currently active main tab
    // Bottom border is handled by the horizontal scroll view for details
  },
